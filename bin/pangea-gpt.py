...
{
	if (region.by.aN === region.bX.aN)
	{
		return 'on line ' + region.by.aN;
	}
	return 'on lines ' + region.by.aN + ' through ' + region.bX.aN;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { c9: 'hidden', c$: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { c9: 'mozHidden', c$: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { c9: 'msHidden', c$: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { c9: 'webkitHidden', c$: 'webkitvisibilitychange' }
		: { c9: 'hidden', c$: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.dh, request.dG, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {b1: fragment, b5: host, ck: path, cm: port_, cr: protocol, cs: query};
	});
...
var $author$project$Main$init = _Utils_Tuple2(
	{N: _List_Nil, O: '', aG: _List_Nil, aK: false, bd: _List_Nil, aP: '', aQ: ''},
	$elm$core$Platform$Cmd$none);
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Main$User = 0;
...
var $author$project$Main$addRedacted = F2(
	function (redaction, messages) {
		return A3(
			$elm_community$list_extra$List$Extra$updateAt,
			$elm$core$List$length(messages) - 1,
			$elm$core$Tuple$mapSecond(
				$elm$core$Basics$always(
					$elm$core$Maybe$Just(redaction))),
			messages);
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cW: false, bM: r.bM, c6: r.c6, b2: r.b2, dh: r.dh, dC: r.dC, cK: r.cK, dG: r.dG}));
};
var $elm$http$Http$post = function (r) {
	return $elm$http$Http$request(
		{bM: r.bM, c6: r.c6, b2: _List_Nil, dh: 'POST', dC: $elm$core$Maybe$Nothing, cK: $elm$core$Maybe$Nothing, dG: r.dG});
};
...
var $author$project$Main$encodeChatMessage = function (_v0) {
	var role = _v0.bg;
	var content = _v0.a5;
		...
		_List_fromArray(
			[
				...
				$elm$json$Json$Encode$string(
					$author$project$Main$roleToString(role))),
				_Utils_Tuple2(
				'content',
...
var $author$project$Main$encodePrevious = $elm$json$Json$Encode$list(
	function (_v0) {
		var message = _v0.a;
		var redaction = _v0.b;
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Main$encodeChatMessage(message),
					$elm$json$Json$Encode$string(redaction)
				]));
	});
var $author$project$Main$serverRequest = F2(
		...
		return $elm$json$Json$Encode$object(
			_List_fromArray(
				[
					_Utils_Tuple2(
					'previous',
					$author$project$Main$encodePrevious(previous)),
					_Utils_Tuple2(
					'message',
					$elm$json$Json$Encode$string(message))
				]));
	});
var $author$project$Main$ServerResponse = F6(
	function (previous, chatGPTMessage, chatGPTRedacted, userRedacted, rawRedactUserText, rawRedactGptText) {
		return {bR: chatGPTMessage, bS: chatGPTRedacted, cn: previous, cu: rawRedactGptText, cv: rawRedactUserText, cO: userRedacted};
	});
var $elm$json$Json$Decode$andThen = _Json_andThen;
var $author$project$Main$ChatMessage = F2(
	function (role, content) {
		return {a5: content, bg: role};
	});
var $elm$json$Json$Decode$field = _Json_decodeField;
var $author$project$Main$Assistant = 1;
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Main$roleDecoder = A2(
	...
	function (s) {
		switch (s) {
			...
			default:
				return $elm$json$Json$Decode$fail(s + ' is not a valid Role');
		}
	},
	$elm$json$Json$Decode$string);
var $author$project$Main$chatMessageDecoder = A3(
...
var $author$project$Main$previousDecoder = function (values) {
	if (values.b && values.b.b) {
		var rawMessage = values.a;
		var _v1 = values.b;
		var rawRedaction = _v1.a;
		return A2(
			$elm$core$Result$withDefault,
			$elm$json$Json$Decode$fail('Invalid values for previous message member'),
			A3(
				$elm$core$Result$map2,
				F2(
					function (a, b) {
						return $elm$json$Json$Decode$succeed(
							A2($elm$core$Tuple$pair, a, b));
					}),
				A2($elm$json$Json$Decode$decodeValue, $author$project$Main$chatMessageDecoder, rawMessage),
				A2($elm$json$Json$Decode$decodeValue, $elm$json$Json$Decode$string, rawRedaction)));
	} else {
		return $elm$json$Json$Decode$fail('Invalid values for previous message member');
	}
};
var $elm$json$Json$Decode$value = _Json_decodeValue;
var $author$project$Main$serverResponseDecoder = A7(
	$elm$json$Json$Decode$map6,
	$author$project$Main$ServerResponse,
	A2(
		...
		$elm$json$Json$Decode$list(
			A2(
				$elm$json$Json$Decode$andThen,
				$author$project$Main$previousDecoder,
				$elm$json$Json$Decode$list($elm$json$Json$Decode$value)))),
	A2($elm$json$Json$Decode$field, 'chat_gpt_message', $author$project$Main$chatMessageDecoder),
	A2($elm$json$Json$Decode$field, 'chat_gpt_redacted', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'user_redacted', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'raw_redact_user_text', $elm$json$Json$Decode$string),
	A2($elm$json$Json$Decode$field, 'raw_redact_gpt_text', $elm$json$Json$Decode$string));
var $author$project$Main$chatCall = F2(
	function (previous, message) {
		return $elm$http$Http$post(
			{
				bM: $elm$http$Http$jsonBody(
					A2($author$project$Main$serverRequest, previous, message)),
				c6: A2($elm$http$Http$expectJson, $author$project$Main$MessageReceived, $author$project$Main$serverResponseDecoder),
				dG: '/chat'
			});
	});
...
var $author$project$Main$chatContainerId = 'chat-container';
var $elm$browser$Browser$Dom$setViewportOf = _Browser_setViewportOf;
var $author$project$Main$scrollToNewestChat = A2(
	$elm$core$Task$attempt,
	$elm$core$Basics$always($author$project$Main$NoOp),
	A3($elm$browser$Browser$Dom$setViewportOf, $author$project$Main$chatContainerId, 0, 100000000));
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							...
							{
								N: _Utils_ap(
									A2($author$project$Main$addRedacted, response.cO, model.N),
									_List_fromArray(
										[
											_Utils_Tuple2(
											response.bR,
											$elm$core$Maybe$Just(response.bS))
										])),
								aK: false,
								bd: response.cn,
								aP: response.cu,
						...
						$author$project$Main$scrollToNewestChat);
				} else {
					var err = result.a;
					var errorMessage = function () {
						switch (err.$) {
							case 1:
								return 'Request timed out, check the server';
							case 2:
								return 'Network Error';
							case 3:
								var code = err.a;
								return 'Received a bad status of: ' + $elm$core$String$fromInt(code);
							case 4:
								var e = err.a;
								return 'Received a bad body: ' + e;
							default:
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aG: A2($elm$core$List$cons, errorMessage, model.aG)
							}),
						$elm$core$Platform$Cmd$none);
				}
			default:
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$batch(
						_List_fromArray(
							[
								$author$project$Main$scrollToNewestChat,
								A2($author$project$Main$chatCall, model.bd, model.O)
							])));
		}
	});
var $rtfeldman$elm_css$Css$Structure$Compatible = 0;
var $rtfeldman$elm_css$Css$auto = {cV: 0, c: 0, af: 0, a8: 0, df: 0, al: 0, I: 0, B: 0, ap: 0, y: 0, bi: 0, au: 0, u: 0, D: 'auto'};
...
var $rtfeldman$elm_css$Css$bold = {Q: 0, D: 'bold'};
	...
	function (declaration, _v0) {
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.c2) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.dk, record.c2, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	var declarations = _v0.c3;
	return {
		bQ: charset,
		c3: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		b6: imports,
		ch: namespaces
	};
};
...
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ac: charsProcessed, ah: hash, W: seed, aq: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.ah)) ? (data.W ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.ah)))) : data.W;
	var h0 = acc ^ data.ac;
...
var $robinheghan$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		...
		if (_v0 === 24) {
			...
			return {ac: data.ac + 1, ah: res, W: data.W, aq: data.aq + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bQ: charset, c3: declarations, b6: imports, ch: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bQ: $elm$core$Maybe$Nothing, b6: _List_Nil, ch: _List_Nil, cF: snippets};
};
...
var $author$project$Main$chatMessage = function (_v0) {
	var message = _v0.a;
	var redaction = _v0.b;
	var sender = function () {
		var _v2 = message.bg;
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(sender + ':')
					])),
				$rtfeldman$elm_css$Html$Styled$text(message.a5),
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Redacted Text')
					])),
				A2($rtfeldman$elm_css$Html$Styled$br, _List_Nil, _List_Nil),
				A2(
				$rtfeldman$elm_css$Html$Styled$span,
				_List_fromArray(
					[
						A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'aria-busy', busy)
					]),
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text(
						A2($elm$core$Maybe$withDefault, '', redaction))
					]))
			]));
};
...
var $author$project$Main$chatMessages = function (messages) {
	return A2(
			...
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$vh(80)),
						$rtfeldman$elm_css$Css$overflowY($rtfeldman$elm_css$Css$auto)
					])),
				$rtfeldman$elm_css$Html$Styled$Attributes$id($author$project$Main$chatContainerId)
			]),
		A2($elm$core$List$map, $author$project$Main$chatMessage, messages));
};
...
var $rtfeldman$elm_css$Css$hidden = {r: 0, ap: 0, D: 'hidden', a2: 0};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bT: col, co: problem, cB: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.cB, p.bT, p.co);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bT: 1, f: _List_Nil, g: 1, b: 0, cB: 1, a: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$newLine = function (fragments) {
	return {c8: fragments, ai: $elm$core$Maybe$Nothing};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Line$Helpers$toFragment = F2(
	function (toStyle, _v0) {
		...
		switch (syntax.$) {
			case 0:
				return {cU: '', dr: 0, dB: text};
			case 1:
				return {cU: '', dr: 1, dB: text};
			case 2:
				return {cU: '', dr: 0, dB: text};
			default:
				var c = syntax.a;
				...
				return {cU: additionalClass, dr: requiredStyle, dB: text};
		}
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bT: col, c0: contextStack, co: problem, cB: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cB, s.bT, x, s.f));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{bT: 1, f: s.f, g: s.g, b: s.b + 1, cB: s.cB + 1, a: s.a}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bT: s.bT + 1, f: s.f, g: s.g, b: newOffset, cB: s.cB, a: s.a}));
		};
	});
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.b, s.cB, s.bT, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return (_Utils_eq(newOffset, -1) || (0 <= A3(
			...
			progress,
			0,
			{bT: newCol, f: s.f, g: s.g, b: newOffset, cB: newRow, a: s.a});
	};
};
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {bT: s.bT + (newOffset - s.b), f: s.f, g: s.g, b: newOffset, cB: s.cB, a: s.a};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.cB, s.bT - (floatOffset + s.b), invalid, s.f));
		} else {
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				bZ: expecting,
				b0: $elm$core$Result$Ok($elm$core$Basics$identity),
				b4: $elm$core$Result$Err(invalid),
				ca: $elm$core$Result$Ok($elm$core$Basics$toFloat),
				de: invalid,
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.b, s.cB, s.bT, s.a);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bT: col, f: s0.f, g: s0.g, b: offset, cB: row, a: s0.a});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.b, s.cB, s.bT, s);
	};
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedUnnestable = F2(
	function (options, revAList) {
		...
		var isNotRelevant = options.cc;
		var end = options.bX;
		var innerParsers = options.b9;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Language$Helpers$delimitedHelp = F2(
	function (options, revAList) {
		...
		var _v0 = _Utils_Tuple2(
			$elm$core$String$uncons(options.by),
			$elm$core$String$uncons(options.bX));
		if (_v0.a.$ === 1) {
			var _v1 = _v0.a;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor = function (background) {
	return {aA: background, aj: false, ak: false, aL: false, dB: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$noEmphasis = F2(
	function (text, background) {
		return {aA: background, aj: false, ak: false, aL: false, dB: text};
	});
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor = function (text) {
	return {aA: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$DefaultColor, aj: false, ak: false, aL: false, dB: text};
};
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles = {
	ax: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
	...
	ai: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$backgroundColor(
	...
	aT: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$textColor(
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$theme = {
	...
	ds: $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Monokai$requiredStyles
};
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$styleToCss = function (_v0) {
	var isBold = _v0.aj;
	var isItalic = _v0.ak;
	var isUnderline = _v0.aL;
	var text = _v0.dB;
	var background = _v0.aA;
	return $elm$core$String$concat(
		_List_fromArray(
			[
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Theme$Type$toCss = function (_v0) {
	var requiredStyles = _v0.ds;
	var customStyles = _v0.c1;
	return $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$Style$toCss(
		_Utils_ap(
			_List_fromArray(
				[
					_Utils_Tuple2('.elmsh', requiredStyles.aE),
					_Utils_Tuple2('.elmsh-hl', requiredStyles.ai),
					_Utils_Tuple2('.elmsh-add', requiredStyles.ax),
					_Utils_Tuple2('.elmsh-del', requiredStyles.aF),
					_Utils_Tuple2('.elmsh-comm', requiredStyles.aD),
					_Utils_Tuple2('.elmsh1', requiredStyles.aS),
					_Utils_Tuple2('.elmsh2', requiredStyles.aT),
					_Utils_Tuple2('.elmsh3', requiredStyles.aU),
					_Utils_Tuple2('.elmsh4', requiredStyles.aV),
					_Utils_Tuple2('.elmsh5', requiredStyles.aW),
					_Utils_Tuple2('.elmsh6', requiredStyles.aX),
					_Utils_Tuple2('.elmsh7', requiredStyles.aY)
				]),
			A2(
				$elm$core$List$map,
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$fragmentView = function (_v0) {
	var text = _v0.dB;
	var requiredStyle = _v0.dr;
	var additionalClass = _v0.cU;
...
var $pablohirafuji$elm_syntax_highlight$SyntaxHighlight$View$lineView = F3(
	function (start, index, _v0) {
		var fragments = _v0.c8;
		var highlight = _v0.ai;
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
...
var $author$project$Main$jsonView = F2(
	function (title, rawJSON) {
		return $elm$core$String$isEmpty(rawJSON) ? $rtfeldman$elm_css$Html$Styled$text('') : A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_Nil,
			_List_fromArray(
				[
					...
					A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text(rawJSON)
							])),
					A2(
						$elm$core$Result$map,
						A2(
							...
							$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$toBlockHtml(
								$elm$core$Maybe$Just(1)),
							$rtfeldman$elm_css$Html$Styled$fromUnstyled),
						$pablohirafuji$elm_syntax_highlight$SyntaxHighlight$json(rawJSON)))
				]));
	});
var $author$project$Main$TextInput = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$TextSubmitted = {$: 2};
...
var $rtfeldman$elm_css$Css$fixed = {aB: 0, aO: 0, bi: 0, D: 'fixed'};
...
var $rtfeldman$elm_css$Css$initial = {bE: 0, bF: 0, aB: 0, bH: 0, aa: 0, bI: 0, ab: 0, F: 0, r: 0, a4: 0, A: 0, c: 0, j: 0, af: 0, bp: 0, aH: 0, a7: 0, P: 0, p: 0, aI: 0, h: 0, Q: 0, a8: 0, ce: 0, br: 0, aM: 0, al: 0, I: 0, am: 0, an: 0, S: 0, T: 0, B: 0, ao: 0, a9: 0, e: 0, d: 0, bu: 0, dl: 0, K: 0, bc: 0, ap: 0, y: 0, bi: 0, as: 0, X: 0, at: 0, au: 0, Y: 0, u: 0, av: '', a1: 0, D: 'initial', a2: 0, _: 0};
var $rtfeldman$elm_css$Css$inherit = _Utils_update(
	$rtfeldman$elm_css$Css$initial,
	{D: 'inherit'});
var $rtfeldman$elm_css$Html$Styled$input = $rtfeldman$elm_css$Html$Styled$node('input');
var $rtfeldman$elm_css$Css$none = {aa: 0, bL: 0, r: 0, c: 0, j: 0, da: 0, b7: 0, br: 0, an: 0, S: 0, B: 0, e: 0, d: 0, bu: 0, bc: 0, dp: 0, y: 0, be: 0, du: 0, as: 0, Y: 0, u: 0, i: 0, dF: 0, D: 'none'};
...
var $author$project$Main$messageBox = F2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rtfeldman$elm_css$Html$Styled$Events$onSubmit($author$project$Main$TextSubmitted)
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$placeholder('Send a message'),
									$rtfeldman$elm_css$Html$Styled$Attributes$value(text),
									$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$TextInput),
									$rtfeldman$elm_css$Html$Styled$Attributes$disabled(loading)
								]),
							_List_Nil),
							A2(
							$rtfeldman$elm_css$Html$Styled$input,
...
var $rtfeldman$elm_css$Css$relative = {aO: 0, D: 'relative'};
var $author$project$Main$chatPage = function (model) {
	return A3(
		...
		_List_fromArray(
			[
				...
				_Utils_ap(
					A2($elm$core$List$map, $author$project$Main$errorView, model.aG),
					_List_fromArray(
						[
							$author$project$Main$chatMessages(model.N),
							A2($author$project$Main$messageBox, model.aK, model.O)
						]))),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						A2($author$project$Main$jsonView, 'User Redaction Payload', model.aQ),
						A2($author$project$Main$jsonView, 'GPT Redaction Payload', model.aP)
					]))
			]));
};
				...
				[
					...
					_List_fromArray(
						[
							...
							$rtfeldman$elm_css$Html$Styled$Attributes$href('https://unpkg.com/@picocss/pico@1.*/css/pico.min.css')
						]),
					_List_Nil),
					...
					$author$project$Main$chatPage(model)
				])),
		dD: 'Pangea GPT'
	};
};
